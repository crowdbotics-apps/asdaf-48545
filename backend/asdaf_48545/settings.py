"""
Django settings for asdaf_48545 project.
...
WSGI_APPLICATION = 'asdaf_48545.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "asdaf Support <support@asdaf-48545.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "asdaf_48545 API",
    "DESCRIPTION": "API documentation for asdaf_48545 App",
    "VERSION": "v1",
}
